...
function DetailPage() {
    ...
    if(category === 'event') {
        ...
        // const storeData = data as storeListDataPros;
        const {id, brand, infoList, imgVisual, tel, detailInfo, productList} = data as storeListDataPros;
        return (
                ...
                {data && (
                    <>
                        ...
                        <div className="product-list">
                            <Tab
                                list={["신메뉴", "커피", "베이커리", "콜드브루", "디카페인", "블렌디드", "티", "기타"]}
                                // onClick={tabOnClick}
                            />
